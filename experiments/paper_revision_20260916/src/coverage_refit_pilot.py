...
def main() -> None:
    ...
    cfg0 = {'protocol_id':'SAEPS-PAPER-REVISION-COVERAGE-REFIT-PILOT-V1','architecture':[2,8,1],
            ...
            'data_seeds':([981000+i for i in range(1,101)] if 'coverage_refit_mc100' in str(cfg_path) else [990000+i for i in range(1,11)] if 'coverage_refit_conv' in str(cfg_path) else [980000+i for i in range(1,31)] if 'coverage_refit_mc' in str(cfg_path) else [970001,970002,970003,970004,970005,970006,970007,970008,970009,970010])}
